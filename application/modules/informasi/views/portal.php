<div class="main">
    <div class="page-header">
        ...
        <div class="breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="javascript:void(0)"> Portal </a></div>
        </div>
    </div>
    <div class="card">
        <?php if(isset($list)){?>
        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="pills-tabContent">
                                ...
                                <tr>
                                    ...
                                    <td>
                                            <div class="d-grid gap-2 d-md-block">
                                                <a type="button" href="<?= site_url('portal_edit/'.$data->id)?>" class="btn btn-primary" title="Download"><i class="icon-edit feather"></i>
                                                </a>
                ...
                <div class="tab-pane fade" id="pills-add" role="tabpanel" aria-labelledby="pills-add-tab">
                    <form class="row g-3" method="post" action="<?= site_url('portal_add')?>" enctype='multipart/form-data'>
                        <div class="col-md-6">
    ...
    <?php } elseif(isset($edit)){?>
            ...
            <?php foreach ($table as $data) { ?>
                <form class="row g-3" method="post" action="<?= site_url('portal_update')?>" enctype='multipart/form-data'>
                    <div class="col-md-6">
                        <label for="kategori" class="form-label">Kategori</label>
                        <select class="form-control" id="select2" name="kategori_id" style="width: 100%;" data-placeholder="Choose one.." required>
                            <?php foreach ($kategori as $dkategori) { ?>
    ...
    <div class="modal fade" id="delete<?= $data->id?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?= site_url('portal_delete');?>" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Delete Data</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <h5>Delete Data <?= $data->judul?> ?</h5>

<div class="main">
    <div class="page-header">
        <h4 class="page-title">Tugas dan Fungsi</h4>
        <div class="breadcrumb">
            <div class="breadcrumb-item"><a href="#"> Informasi </a></div>
            <div class="breadcrumb-item"><a href="javascript:void(0)"> Tugas dan Fungsi</a></div>
        </div>
    </div>
    <div class="card">
        <?php if(isset($list)){?>
        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="pills-tabContent">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-grid gap-2 d-md-block">
                                            <a type="button" href="<?= site_url('tupoksi_edit/'.$data->id)?>" class="btn btn-primary" title="Download"><i class="icon-edit feather"></i>
                                            </a>
                ...
                <div class="tab-pane fade" id="pills-add" role="tabpanel" aria-labelledby="pills-add-tab">
                    <form class="row g-3" method="post" action="<?= site_url('tupoksi_add')?>">
                        <div class="mb-3">
                            <label for="tugas" class="form-label">Tugas</label>
                            <textarea  id="editor" name="tugas"></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="fungsi" class="form-label">Fungsi</label>
                            <textarea  id="editor1" name="fungsi"></textarea>
                        </div>
    ...
    <?php } elseif(isset($edit)){?>
            ...
            <form class="row g-3" method="post" action="<?= site_url('tupoksi_update')?>">
                <div class="mb-3">
                    <label for="tugas" class="form-label">Tugas</label>
                    <input type="hidden" name="id" class="form-control" id="id" value="<?= $data->id;?>">
                    <textarea  id="editor" name="tugas"><?= $data->tugas?></textarea>
                </div>
                <div class="mb-3">
                    <label for="fungsi" class="form-label">Fungsi</label>
                    <textarea  id="editor1" name="fungsi"><?= $data->fungsi?></textarea>
                </div>
                <div class="mt-5 pt-3 text-end">
                    <button type="submit" class="btn btn-secondary me-2">Discard</button>
                    <button type="submit" class="btn btn-primary">Sent</button>
    ...
    <div class="modal fade" id="delete<?= $data->id?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?= site_url('tupoksi_delete');?>" method="post">

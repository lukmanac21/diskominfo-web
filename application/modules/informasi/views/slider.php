<div class="main">
    <div class="page-header">
        ...
        <div class="breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="javascript:void(0)"> Slider </a></div>
        </div>
    </div>
    <div class="card">
        <?php if(isset($list)){?>
        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="pills-tabContent">
                        ...
                        <tbody>
                                <?php $no = 1; foreach ($table as $data) { ?>
                                    <tr>
                                        ...
                                        <td class="font-w600"><img src="<?= base_url()?>assets/frontend/slider/<?= $data->picture?>" height="100px" width="150px"></td>
                                        <td><?php if($data->is_active == 1){$checkStatus = 'checked';}else{$checkStatus = '';}?>
                                            <div class="form-check form-switch">
                                                <form id="form_<?= $data->id ?>" action="<?= site_url('slider_check')?>" method="post">
                                        ...
                                        <td>
                                                <div class="d-grid gap-2 d-md-block">
													<a type="button" href="<?= site_url('slider_edit/'.$data->id)?>" class="btn btn-primary" title="Download"><i class="icon-edit feather"></i>
                                                    </a>
                ...
                <form class="row g-3" method="post" action="<?= site_url('slider_add')?>" enctype='multipart/form-data'>
                    <div class="col-md-6">
    ...
    <?php } elseif(isset($edit)){?>
            ...
            <?php foreach ($table as $data) { ?>
                <form class="row g-3" method="post" action="<?= site_url('slider_update')?>" enctype='multipart/form-data'>
                    <div class="col-md-6">
                        <label for="name" class="form-label">Module</label>
    ...
    <div class="modal fade" id="delete<?= $data->id?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?= site_url('slider_delete');?>" method="post">

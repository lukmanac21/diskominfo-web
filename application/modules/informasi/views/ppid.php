<div class="main">
    <div class="page-header">
        ...
        <div class="breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="javascript:void(0)"> PPID </a></div>
        </div>
    </div>
    <div class="card">
        <?php if(isset($list)){?>
        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                <div class="d-grid gap-2 d-md-block">
													<a type="button" href="<?= site_url('ppid_edit/'.$data->id)?>" class="btn btn-primary" title="Download"><i class="icon-edit feather"></i>
                                                    </a>
                ...
                <form class="row g-3" method="post" action="<?= site_url('ppid_add')?>" enctype='multipart/form-data'>
                    <div class="col-md-6">
    ...
    <?php } elseif(isset($edit)){?>
            ...
            <?php foreach ($table as $data) { ?>
                <form class="row g-3" method="post" action="<?= site_url('ppid_update')?>">
                    <div class="col-md-6">
                        <label for="date" class="form-label">Tanggal</label>
    ...
    <div class="modal fade" id="delete<?= $data->id?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?= site_url('ppid_delete');?>" method="post">

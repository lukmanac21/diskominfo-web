...
<div class="side-nav vertical-menu nav-menu-light scrollable">
    ...
    <li class="nav-group-title">DASHBOARD</li>
        ...
        <?php if ($this->rbac->hasPrivilege('kategori_konten', 'can_view')) { ?>
        <li class="nav-group-title">Kategori</li>
        <?php if ($this->rbac->hasPrivilege('kategori_konten', 'can_view')) { ?>
        <li class="nav-menu-item <?= ($this->uri->segment(2) === 'kategori_konten') ? 'router-link-active' : '' ?>"> <a href="<?php echo site_url('kategori_konten'); ?>"><i class="feather icon-list" data-i18n="kategori_konten"></i> <span class="nav-menu-item-title">Kategori Konten</span></a></li>
        <?php } ?>
        <?php if ($this->rbac->hasPrivilege('portal', 'can_view')) { ?>
        <li class="nav-menu-item <?= ($this->uri->segment(2) === 'portal') ? 'router-link-active' : '' ?>"> <a href="<?php echo site_url('kategori_portal'); ?>"><i class="feather icon-list" data-i18n="portal"></i> <span class="nav-menu-item-title">Kategori Portal</span></a></li>
        <?php } ?>
        <?php if ($this->rbac->hasPrivilege('galeri', 'can_view')) { ?>
        <li class="nav-menu-item <?= ($this->uri->segment(2) === 'galeri') ? 'router-link-active' : '' ?>"> <a href="<?php echo site_url('kategori_galeri'); ?>"><i class="feather icon-list" data-i18n="galeri"></i> <span class="nav-menu-item-title">Kategori Galeri</span></a></li>
        <?php } ?>
        <?php } ?>
        <?php } ?> -->
        ...
        <?php if ($this->rbac->hasPrivilege('slider', 'can_view')) { ?>
        <li class="nav-menu-item <?= ($this->uri->segment(2) === 'slider') ? 'router-link-active' : '' ?>"> <a href="<?php echo site_url('slider'); ?>"><i class="icon-sliders feather" data-i18n="slider"></i> <span class="nav-menu-item-title">Slider</span></a></li>
        <?php } ?>
        ...
        <?php } ?>
        <?php if ($this->rbac->hasPrivilege('sosialmedia', 'can_view')) { ?>
        <li class="nav-menu-item <?= ($this->uri->segment(2) === 'sosialmedia') ? 'router-link-active' : '' ?>"> <a href="<?php echo site_url('sosialmedia'); ?>"><i class="icon-aperture feather" data-i18n="sosialmedia"></i> <span class="nav-menu-item-title">Sosial Media</span></a></li>
        <?php } ?>
        ...
        <?php if  ($this->rbac->hasPrivilege('opd', 'can_view') || $this->rbac->hasPrivilege('kecamatan', 'can_view')) { ?>
        <li class="nav-group-title">PORTAL</li>
        ...
        <?php } ?>
        <?php if ($this->rbac->hasPrivilege('kecamatan', 'can_view')) { ?>
        <li class="nav-menu-item <?= ($this->uri->segment(2) === 'kecamatan') ? 'router-link-active' : '' ?>"> <a href="<?php echo site_url('kecamatan'); ?>"><i class="feather icon-list" data-i18n="kecamatan"></i> <span class="nav-menu-item-title">Kecamatan</span></a></li>
        <?php } ?>
        <?php } ?>
        <?php } ?>
    </ul>
